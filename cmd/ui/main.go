...
type config struct {
	...
	HTTPAdapterURL  string          `env:"MG_HTTP_ADAPTER_URL"    envDefault:"http://http-adapter:8008"`
	ReaderURL       string          `env:"MG_READER_URL"          envDefault:"http://mongodb-reader:9007"`
	ThingsURL       string          `env:"MG_THINGS_URL"          envDefault:"http://things:9000"`
	UsersURL        string          `env:"MG_USERS_URL"           envDefault:"http://users:9002"`
	HostURL         string          `env:"MG_UI_HOST_URL"         envDefault:"http://localhost:9095"`
	BootstrapURL    string          `env:"MG_BOOTSTRAP_URL"       envDefault:"http://bootstrap:9013"`
	DomainsURL      string          `env:"MG_DOMAINS_URL"         envDefault:"http://domains:8189"`
	InvitationsURL  string          `env:"MG_INVITATIONS_URL"     envDefault:"http://invitations:9020"`
