...
type config struct {
	...
	KratosURL          string          `env:"MF_UI_KRATOS_URL"             envDefault:"http://localhost:4433"`
	KratosClientID     string          `env:"MF_UI_KRATOS_CLIENT_ID"       envDefault:""`
	KratosClientSecret string          `env:"MF_UI_KRATOS_CLIENT_SECRET"   envDefault:""`
	KratosRedirectURL  string          `env:"MF_UI_KRATOS_REDIRECT_URL"    envDefault:"http://localhost/oauth/callback/kratos"`
	KratosState        string          `env:"MF_UI_KRATOS_STATE"           envDefault:""`
}
